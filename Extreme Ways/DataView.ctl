...
Event IconEnter(str As String)

Public sel As String
Public air As String
Dim m_over As Integer
...
If str <> "REPAIR" And str <> "SELL" Then
...
Set img(img.UBound).Picture = LoadPicture(App.path & "\images\buildbar\Sell.gif")
End If
...
If m_over <> Index Then
RaiseEvent IconEnter(img(Index).Tag)
m_over = Index
End If
End Sub
